...
<div id='find-username-password'>
	...
	<form method='post' autocomplete='off'>
		...
		<table id='text-box-group' cellpadding=0 cellspacing=0>
			<tr>
				<td><span class='sub-title'>아이디</span></td><td width=10></td><td><input type='text' name='username' /></td>
			</tr>
			<tr>
				<td><span class='sub-title'>등록한 이메일</span></td><td width=10></td><td><input type='text' name='email' /></td>
			</tr>
		</table>
		</center>
